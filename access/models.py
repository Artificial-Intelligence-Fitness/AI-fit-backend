...
from photos.models import AbstractModel
...
class User(AbstractModel, AbstractBaseUser):
    ...
    is_active = models.BooleanField(
        _("Active"),
        help_text="Designates whether the user can access their accounts",
        default=True,
    )
    is_admin = models.BooleanField(
        _("Admin"),
        help_text="Designates whethe the user can log into this admin site",
        default=False,
    )
